...
count_med_strips_with_available_count(name='Levipil 500', per_day=2, per_strip=10, available_count=650)
count_med_strips_with_available_count(name='Cardiace 5', per_day=3, per_strip=10, available_count=780)
count_med_strips_with_available_count(name='Azoran', per_day=3, per_strip=10, available_count=1200)
count_med_strips_with_available_count(name='HCQS 200', per_day=2, per_strip=15, available_count=390)
count_med_strips_with_available_count(name='Omnacortil 2.5', per_day=3, per_strip=10, available_count=290)
count_med_strips_with_available_count(name='Ecosporin 75', per_day=1, per_strip=10, available_count=672)
count_med_strips_with_available_count(name='Shellcal HD', per_day=1, per_strip=15, available_count=390)
count_med_strips_with_available_count(name='Osteofos 70', per_day=1. / 7, per_strip=4, available_count=72)
